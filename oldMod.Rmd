...
for (i in (10))
{
 ...
 #ARIMA MSE
  ...
  # library(openxlsx)
  # wb <- loadWorkbook("~/Desktop/actualoutput.xlsx")
  # addWorksheet(wb,"nx-55-beko-turkey")
  df <- data.frame(result)
  # writeData(wb,"nx-55-beko-turkey",df)
  # saveWorkbook(wb,"~/Desktop/actualoutput.xlsx",overwrite = TRUE)
 ...
 #ARIMA MSE
  ...
  library(openxlsx)
  # wb <- loadWorkbook("~/Desktop/simulatedoutput.xlsx")
  # addWorksheet(wb,"nx-55-beko-turkey")
  df <- data.frame(result2)
  # writeData(wb,"nx-55-beko-turkey",df)
  # saveWorkbook(wb,"~/Desktop/simulatedoutput.xlsx",overwrite = TRUE)
